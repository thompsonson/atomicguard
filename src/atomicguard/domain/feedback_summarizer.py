...
Domain service implementing Extension 09 Definitions:
- Definition 44: Stagnation Detection (global and per-guard)
- Definition 48: Context Injection (failure summary generation)

This is a domain service — pure business rules with no orchestration
...
from atomicguard.domain.models import Artifact, StagnationInfo
