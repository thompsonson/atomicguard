...
1. Step 1: Generate tests with SyntaxGuard + HumanReviewGuard
...
Usage:
    python -m examples.tdd_human_review.run
    python -m examples.tdd_human_review.run --host http://gpu:11434
    python -m examples.tdd_human_review.run --model llama3.2:3b
"""
...
def main(
    ...
    # Setup logging
    logger = setup_logging("tdd_human_review", log_path, verbose)
